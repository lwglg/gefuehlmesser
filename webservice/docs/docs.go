    ...
    "definitions": {
        ...
        "sentiment.Feed": {
            ...
            "properties": {
                ...
                "time_window_minutes": {
                    "description": "A janela de tempo, em minutos, na qual serão consideradas mensagens para a análise de sentimentos",
                    "type": "integer",
                    "minimum": 0
                }
            }
        ...
        "sentiment.FeedSentimentFlags": {
            ...
            "properties": {
                "candidate_awareness": {
                    "description": "Indica se o conteúdo normalizado da mensagem corresponde a \"teste tecnico mbras\"",
                    "type": "boolean"
                },
                "mbras_employee": {
                ...
                "special_pattern": {
                    "description": "Indica a condição anterior e se também a mensagem possui exatamente 42 caracteres",
                    "type": "boolean"
                }
            }
        },
        "sentiment.MessageSentiment": {
            ...
            "properties": {
                "label": {
                    "description": "Categoria do sentimento (\"positive\" | \"negative\" | \"neutral\"), de acordo com o valor do escore",
                    "type": "string"
                },
                "processing_time_ms": {
                    "description": "Auxiliar. Tempo de processamento da análise em milissegundos",
